unit OdrzavanjeOpremaZaPopravka;
...
type
  TFormaOdrzavanjeOpremaZaPopravku = class(TForm)
    Grid1: TGrid;
    Button1: TButton;
    Image1: TImage;
    FDConnection1: TFDConnection;
    BindSourceOpremaZaPopravku: TBindSourceDB;
    FDTableOpremaZaPopravku: TFDTable;
    LinkGridToDataSourceBindSourceOpremaZaPopravku: TLinkGridToDataSource;
    NavigatorBindSourceOpremaZaPopravku: TBindNavigator;
...
var
  FormaOdrzavanjeOpremaZaPopravku: TFormaOdrzavanjeOpremaZaPopravku;

implementation
uses OdrzavanjeDruga;
{$R *.fmx}

procedure TFormaOdrzavanjeOpremaZaPopravku.Button1Click(Sender: TObject);
begin
