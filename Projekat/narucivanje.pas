...
dbform.FDQuery2.SQL.Text := 'INSERT INTO narudzbenice (id_dobavljaca, id_snabdevaca, datum) ' +
                     'VALUES ('''+ Dcombobox.Selected.Text+ ''', '''+Scombobox.Selected.Text+''','''+narudzbenicaDate.text +''')';
...
begin
DComboBox.items.Add(dbform.FDQuery2.FieldByName('id_dobavljaca').AsString);
...
for I := 1 to dbform.FDQuery2.RecordCount do
begin
SComboBox.items.Add(dbform.FDQuery2.FieldByName('id_snabdevaca').AsString);
dbform.FDQuery2.next;
end;
